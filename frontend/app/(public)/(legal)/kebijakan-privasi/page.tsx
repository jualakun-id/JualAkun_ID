...
export default function KebijakanPrivasiPage() {
  return (
    <section className="container mx-auto max-w-3xl px-4 py-12 text-ink-muted">
      <h1 className="font-heading text-h1 text-ink">Kebijakan Privasi</h1>
      <p className="mt-2 text-sm text-ink-subtle">Versi 1.0 — berlaku 2026-05-09</p>

      <h2 className="mt-8 font-heading text-h2 text-ink">1. Data yang Kami Kumpulkan</h2>
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">2. Penggunaan Data</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">3. Penyimpanan &amp; Keamanan</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">4. Pihak Ketiga</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">5. Hak Anda</h2>
      <p className="mt-2">
