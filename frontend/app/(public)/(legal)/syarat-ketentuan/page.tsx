...
export default function SyaratKetentuanPage() {
  return (
    <section className="container mx-auto max-w-3xl px-4 py-12 text-ink-muted">
      <h1 className="font-heading text-h1 text-ink">Syarat &amp; Ketentuan</h1>
      <p className="mt-2 text-sm text-ink-subtle">Versi 1.0 — berlaku 2026-05-09</p>

      <h2 className="mt-8 font-heading text-h2 text-ink">1. Penerimaan Syarat</h2>
      <p className="mt-2">
        Dengan menggunakan layanan Jualakun.id, Anda menyetujui untuk terikat oleh syarat dan
        ketentuan ini.
      </p>

      <h2 className="mt-6 font-heading text-h2 text-ink">2. Akun Pengguna</h2>
      <p className="mt-2">
        Anda bertanggung jawab atas keamanan akun, password, dan semua aktivitas yang terjadi di akun
        Anda.
      </p>

      <h2 className="mt-6 font-heading text-h2 text-ink">3. Pembelian &amp; Pengiriman</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">4. Garansi</h2>
      <p className="mt-2">
        Garansi berlaku sesuai durasi yang tertera pada masing-masing produk. Klaim garansi dilakukan via
        tiket di dashboard.
      </p>

      <h2 className="mt-6 font-heading text-h2 text-ink">5. Larangan</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-ink">6. Perubahan Syarat</h2>
      <p className="mt-2">
