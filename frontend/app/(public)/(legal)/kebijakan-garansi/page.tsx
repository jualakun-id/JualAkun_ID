...
export default function KebijakanGaransiPage() {
  return (
    <section className="container mx-auto max-w-3xl px-4 py-12 text-text-muted">
      <h1 className="font-heading text-h1 text-text">Kebijakan Garansi &amp; Refund</h1>

      <h2 className="mt-8 font-heading text-h2 text-text">1. Cakupan Garansi</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-6 font-heading text-h2 text-text">2. Yang Tidak Tercakup</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6">
      ...
      <h2 className="mt-6 font-heading text-h2 text-text">3. Cara Klaim</h2>
      ...
      <h2 className="mt-6 font-heading text-h2 text-text">4. Resolusi</h2>
      <p className="mt-2">
