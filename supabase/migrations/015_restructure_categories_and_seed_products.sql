...
--
-- Prerequisite:
--   Bucket 'product-thumbnails' must exist (public) with all 16 .jpeg files uploaded.
-- =============================================================
...
SELECT id, 'Google Ultra 30D (Garansi 1D)', 'google-ultra-30d-1',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/google-ultra-30d-1.jpeg',
...
SELECT id, 'Google Ultra 30D (Full Garansi)', 'google-ultra-30d-full',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/google-ultra-30d-full.jpeg',
...
SELECT id, 'ChatGPT Plus 1 Bulan', 'chatgpt-plus-1m',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/chatgpt-plus-1m.jpeg',
...
SELECT id, 'Claude Pro (Full Garansi)', 'claude-pro',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/claude-pro.jpeg',
...
SELECT id, 'Claude X5 (Full Garansi)', 'claude-x5',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/claude-x5.jpeg',
...
SELECT id, 'Grok Super 30D (Garansi 15D)', 'grok-super-30d',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/grok-super-30d.jpeg',
...
SELECT id, 'Gemini AI Pro 18 Bulan', 'gemini-ai-pro-18m',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/gemini-ai-pro-18m.jpeg',
...
SELECT id, 'Adobe CC + Firefly 3 Bulan', 'adobe-cc-firefly-3m',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/adobe-cc-firefly-3m.jpeg',
...
SELECT id, 'ElevenLabs Creator', 'eleven-labs-creator',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/eleven-labs-creator.jpeg',
...
SELECT id, 'Krea Business (Garansi 10D)', 'krea-business',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/krea-business.jpeg',
...
SELECT id, 'CapCut Pro 35 Hari (Full Garansi)', 'capcut-pro-35d',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/capcut-pro-35d.jpeg',
...
SELECT id, 'CapCut Pro 6 Bulan (Full Garansi)', 'capcut-pro-6m',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/capcut-pro-6m.jpeg',
...
SELECT id, 'Canva Pro 1 Tahun (Full Garansi)', 'canva-pro-1y',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/canva-pro-1y.jpeg',
...
SELECT id, 'Suno Premium 30 Hari', 'suno-premium-30d',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/suno-premium-30d.jpeg',
...
SELECT id, 'Adobe Stock Contributor', 'adobe-contributor',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/adobe-contributor.jpeg',
...
SELECT id, 'Kling AI 1100 Credit (Garansi 30D)', 'kling-ai-1100',
  ...
  'https://clfewheqatyaefohmdpn.supabase.co/storage/v1/object/public/product-thumbnails/kling-ai-1100.jpeg',
